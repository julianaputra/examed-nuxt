      ...
      <div class="container">
        ...
        <Transition mode="out-in">
          ...
          >
            ...
            <template v-if="activeQuestion?.question.title" #subtitle>
              {{ activeQuestion?.question.title }}
            </template>
            <template v-if="activeQuestion?.question.content" #content>
              <div v-if="activeQuestion?.question.type === 'checkbox'">
                <UiCheckbox
                  v-for="(q, qIndex) in activeQuestion.question.content"
                  :key="qIndex"
                  >{{ q }}</UiCheckbox
                >
              </div>
            ...
            <template #footer>
              ...
              >
                <UiButton
                  variant="outline"
                  @click="setNextQuestion(activeQuestion?.answer.target?.false)"
                  >Tidak</UiButton
                >
                <UiButton
                  @click="setNextQuestion(activeQuestion?.answer.target?.true)"
                  >Ya</UiButton
                >
              </div>
              <div
              ...
              >
                <UiButton
                  @click="setNextQuestion(activeQuestion?.answer.target)"
                  >Lanjutkan</UiButton
                >
              </div>
            </template>
