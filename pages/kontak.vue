        ...
        <div class="col-12 col-lg-5">
          <div class="kontak__info">
            ...
            <p class="kontak__desc">
              Apakah Anda ingin menggunkaan produk kakmi? Apakah Anda memiliki
              pertanyaan tentang kami? Jangan ragu untuk menghubungi kami,
            </p>
            <div class="kontak__info-container">
              ...
              <p class="kontak__info-desc">
                <a href="mailtoinfo@examed.id" class="kontak__info-link">
                  info@examed.id
                </a>
              </p>
            </div>
            <div class="kontak__info-container">
              <h2 class="kontak__info-title">
                <Icon name="ic:baseline-whatsapp" class="kontak__info-icon" />
                Whatsapp
              </h2>
              <p class="kontak__info-desc">
          ...
          <Form>
            <div class="form-group">
              ...
              <Field
                ...
                class="form-control"
              />
              <ErrorMessage class="form__error-message" name="nama" />
            </div>
            <div class="form-group">
              ...
              <Field
                ...
                class="form-control"
              />
              <ErrorMessage class="form__error-message" name="no-hp" />
            </div>
            <div class="form-group">
            ...
            <button class="themeBtnBold"><span> Kirim </span></button>
          </Form>
        </div>
      </div>
    </div>
