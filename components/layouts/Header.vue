                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav custom-navbar__navbar-nav">
                                    ...
                                    <div class="row gy-1">
                                        <div class="col-12 col-xl-6">
                                            <NuxtLink to="/depresi"
                                                ...
                                                <span class="dropdown-item custom-navbar__dropdown-sub-title">Depresi
                                                </span>
                                        ...
                                        <div class="col-12 col-xl-6">
                                            <NuxtLink to="/psikosis"
                                                class="custom-navbar__list-dropdown custom-navbar__list-dropdown--border">
                                                <span class="dropdown-item custom-navbar__dropdown-sub-title">Psikosis
                                                </span>
                                                <img src="/images/ic-arrow-right.svg" alt="Ic-arrow"
                                                    class="nav-item__arrow" />
                                            </NuxtLink>
                                        ...
                                        <div class="col-12 col-xl-6">
                                            <NuxtLink to="/psikosis"
                                                class="custom-navbar__list-dropdown custom-navbar__list-dropdown--border">
                                                <span class="dropdown-item custom-navbar__dropdown-sub-title">Demensia
                                                </span>
                                                <img src="/images/ic-arrow-right.svg" alt="Ic-arrow"
                                                    class="nav-item__arrow" />
                                            </NuxtLink>
                                        ...
                                        <div class="col-12 col-xl-6">
                                            <NuxtLink to="/layanan/perawatan-praktek-penting"
                                                class="custom-navbar__list-dropdown custom-navbar__list-dropdown--border">
                                                <span class="dropdown-item custom-navbar__dropdown-sub-title">Gangguan
                                                    Mental &
                                                    Perilaku Anak &
                                                    Remaja
                                                </span>
                                        ...
                                        <div class="col-12 col-xl-6">
                                            <NuxtLink to="/menyakiti-diri-sendiri-bunuh-diri"
                                                class="custom-navbar__list-dropdown custom-navbar__list-dropdown--border">
                                                <span class="dropdown-item custom-navbar__dropdown-sub-title">Menyakiti
                                                    Diri
                                                    Sendiri / Bunuh
                                                    Diri
                                                </span>
                                        ...
                                        <div class="col-12 col-xl-6">
                                            <NuxtLink to="/layanan/perawatan-praktek-penting"
                                                class="custom-navbar__list-dropdown custom-navbar__list-dropdown--border">
                                                <span class="dropdown-item custom-navbar__dropdown-sub-title">Keluhan
                                                    Kesehatan
                                                    Mental Penting
                                                    Lainnya
                                                </span>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu custom-navbar__wrap-dropdown  ">
                                    <NuxtLink to="/layanan/bagan-induk"
                                        class="custom-navbar__list-dropdown custom-navbar__list-dropdown--border   ">
                                        <span class="dropdown-item custom-navbar__dropdown-sub-title">Bagan Induk
                                        </span>
                                        <img src="/images/ic-arrow-right.svg" alt="Ic-arrow" class="nav-item__arrow" />
                                    </NuxtLink>
                                    <NuxtLink to="/layanan/perawatan-praktek-penting"
                                        class="custom-navbar__list-dropdown custom-navbar__list-dropdown--border   ">
                                        <span class="dropdown-item custom-navbar__dropdown-sub-title">Perawatan &
                                            Praktek
                                            Penting
                                        </span>
                                        <img src="/images/ic-arrow-right.svg" alt="Ic-arrow" class="nav-item__arrow" />
                                    ...
                                    <NuxtLink to="/layanan/manajemen-kedokteran-keluarga"
                                        ...
                                        <span class="dropdown-item custom-navbar__dropdown-sub-title">Manajemen
                                            Kedokteran
                                            Keluarga
                                        </span>
                                        <img src="/images/ic-arrow-right.svg" alt="Ic-arrow" class="nav-item__arrow" />
